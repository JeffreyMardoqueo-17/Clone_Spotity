...
// El componente ahora acepta los props que deben cumplir con la interfaz IEstaciones
    ...
    return (
        <div className="group relative bg-neutral-800 rounded-lg p-4 w-48">
            ...
            <div className="relative">
                <img
                    src={img} // Usar la imagen pasada como prop
                    alt={titulo} // Usar el título como alt
